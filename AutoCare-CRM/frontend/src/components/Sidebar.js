  ...
  return (
    <div className={`w-56 h-screen fixed overflow-y-auto transition-all duration-300 ease-in-out ${darkMode ? 'bg-gray-800' : 'bg-gray-900'}`}>
      <div className="flex items-center justify-center py-6 border-b border-gray-700">
        <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-2 rounded-full hover:scale-105 transition-transform duration-300 border-2 border-white/20">
          <img 
            src="/logo.png" 
            alt="AutoCare CRM" 
